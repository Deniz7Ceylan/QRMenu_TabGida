...
namespace QRMenu_TabGida.Controllers
{
    public class FoodsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Photo,NutritionalValue,Ingredients,Price,Description,CategoryId")] Food food)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Photo,NutritionalValue,Ingredients,Price,Description,CategoryId")] Food food)
        {
            if (id != food.Id)
            {
                return NotFound();
